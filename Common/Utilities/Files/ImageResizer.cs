...
namespace Utilities.Files
{
    public class ImageResizer
    {
        ...
        #region ریسایز کردن تصویر با داشتن ماکزیمم طول و ماکزیمم عرض
        /// <summary>
        /// ریسایز کردن تصویر با داشتن ماکزیمم طول و ماکزیمم عرض
        /// </summary>
        /// <param name="inFile">آدرس فایل ورودی</param>
        /// <param name="outFile">آدرس فایل خروجی</param>
        /// <param name="ResizeMaxWidth">ماکزیمم طول</param>
        /// <param name="ResizeMaxHeight">ماکزیمم ارتفاع</param>
        /// <param name="level">دقت</param>
        /// <returns></returns>
        ...
        #region ریسایز کردن تصویر با داشتن ماکزیمم طول یا عرض
        /// <summary>
        /// ریسایز کردن تصویر با داشتن ماکزیمم طول یا عرض
        /// </summary>
        /// <param name="maxDimension">ماکزیمم طول یا عرض</param>
        public async static Task ResizeImage(string inFile, string outFile,
        ...
        #region کراپ کردن تصویر

        /// <summary>
        /// کراپ کردن عکس
        /// </summary>
        /// <param name="inFile">آدرس فایل رودی</param>
        /// <param name="outFile">آدرس فایل خروجی</param>
        /// <param name="CropWidth">طول کراپ</param>
        /// <param name="CropHeight">ارتفاع کراپ</param>
        /// <param name="level">کیفیت</param>
        public async static Task CropImage(string inFile, string outFile,
           int CropWidth, int CropHeight, long level)
        {
            ...
            using (MemoryStream memStream = new MemoryStream(buffer))
            {
                using (Image inImage = Image.FromStream(memStream))
                {
                    ...
                    int marginLeft = 0;
                    int marginTop = 0;
                    float ac = inImage.Width / (float)inImage.Height;
