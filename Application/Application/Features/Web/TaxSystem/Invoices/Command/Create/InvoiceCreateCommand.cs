...
namespace Application.Features.Web.Invoices
{
    ...
    : IRequest<BaseResult<long>>, IMapFrom<Invoice>
    {
        #region Constructors
        ...
        public void Mapping(Profile profile) =>
            profile.CreateMap<InvoiceCreateCommand, Invoice>()
    ...
    public record class InvoiceItemCreateDTO : IMapFrom<InvoiceItem>
    {
        #region Properties
        /// <summary>
        /// نام کالا یا خدمت
        ...
        #region Mapping
        public void Mapping(Profile profile) =>
            profile.CreateMap<InvoiceItemCreateDTO, InvoiceItem>()
    ...
    #region Handler
    public class InvoiceCreateCommandHandler : IRequestHandler<InvoiceCreateCommand, BaseResult<long>>
    {
        ...
        public async Task<BaseResult<long>> Handle(InvoiceCreateCommand request, CancellationToken cancellationToken)
        {
            #region گرفتن شرکت
