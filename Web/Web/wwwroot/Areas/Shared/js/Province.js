...
breadcrumb.push({ title: "استان", link: "#" });




// عملیات مربوط به مدیریت استان ها
var _area = "shared";
var _controller = "provinces";
var entity = {
    ...
    // افزودن استان جدید
    create: {
        // لود کردن فرم افزودن استان جدید
        loadForm: function () {
    ...
    delete: {
        loadForm: function (id) {
            if (!id)
                showNotification("لطفا ابتدا استان مورد نظر را انتخاب نمایید !");
            else
                swal({
                    title: 'آیا مطمئنید ؟',
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isSuccess) {
                        ...
                        swal({
                            title: 'حذف شد !',
                            text: 'استان مورد نظر با موفقیت حذف شد',
                            type: 'success',
                        ...
                        swal({
                            title: 'حذف نشد !',
                            text: 'حذف استان با خطا همراه بوده است. مجددا اقدام کنید!',
                            type: 'error',
                            confirmButtonClass: "btn btn-danger",
                            confirmButtonText: "باشه",
                            buttonsStyling: false
