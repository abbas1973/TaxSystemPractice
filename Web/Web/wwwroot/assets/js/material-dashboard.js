 ...
 * =========================================================
 *
 * Copyright 2016 ???? (http://tad-idea.com/product/material-dashboard-pro)
 *
 *
 *                       _oo0oo_
 *                      o8888888o
...
var sidbareScrollbar, panelScrollbar;
 (function(){
     ...
     if (isWindows && !$('body').hasClass('sidebar-mini')){
        ...
        //$('html').addClass('perfect-scrollbar-on');
         ...
         $('.sidebar .sidebar-wrapper').mCustomScrollbar({ theme: "minimal" });
         $('.main-panel').mCustomScrollbar({ theme: "minimal" });
...
md = {
    ...
    //        //ÇÒ ÍÇáÊ ãäæ ÈÓÊå ÈÑæ Èå ãäæ ÈÇÒ
    ...
    initMinimizeSidebar:function(){
        ...
        $('#minimizeSidebar').click(function(){
            ...
            $('.main-panel').mCustomScrollbar("destroy");
           
            setTimeout(function () {
                //$('.main-panel').perfectScrollbar();
                $('.main-panel').mCustomScrollbar({ theme: "dark" });                
            }, 300);
